...
return [
    ...
    'implied_dollar' => [
        ...
        'karat_numerator' => 18,
        'karat_denominator' => 24,
        'decimals' => 0,
        'disclaimer' => 'این عدد نرخ دلار بازار آزاد یا رسمی نیست. از فرمول (قیمت هر گرم طلای ۱۸ عیار × ۳۱٫۱۰۳۵ × ۲۴) ÷ (قیمت انس طلا به دلار × ۱۸) و بر اساس داده‌های اتحادیه طلا (estjt.ir) محاسبه شده است. فقط یک برآورد تحلیلی از نسبت طلا و ارز است و ممکن است با نرخ واقعی خرید و فروش دلار متفاوت باشد.',
    ],
    'features' => [
        'dark_mode' => true,
    ],
